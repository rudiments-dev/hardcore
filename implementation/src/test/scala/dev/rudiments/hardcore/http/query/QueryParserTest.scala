...
import dev.rudiments.hardcore.http.query.blueprints.{IntEquals, IntLess, IsDefined, IsEmpty, OptionValuePredicate, ProductFieldPredicate, StartsWith, StringEquals}
